...
UPDATE entries
	SET title='Queso', content='Back is back', id_author=(SELECT id_author FROM authors WHERE email='alejandru@thebridgeschool.es'),  category='Software'
...
UPDATE authors
    SET name='Alex', surname='Reinote', email='alejandru@thebridgeschool.es', image='https://randomuser.me/api/portraits/thumb/men/75.jpg'
    WHERE email='alejandru@thebridgeschool.es';
-- Borra una entrada 
DELETE FROM entries
    WHERE title='Estamos de Lunes de Back';
